...
pub fn new_full_base(
	...
	// let key_store = keystore_container.sync_keystore();
	// SyncCryptoStore::ed25519_generate_new(&key_store, b"comm".into(), dev_seed).expect("Dev seed");
	// if let Some(seed) = dev_seed {  
	// 	SyncCryptoStore::ed25519_generate_new(&key_store, b"comm", Some(&seed)).expect("Dev seed");
	// 	let keystore = keystore_container.sync_keystore();
	// 	(*keystore as SyncCryptoStore).
	// 	// 	.sync_keystore()  
