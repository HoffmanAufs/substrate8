...
// parameter_types! {
// 	pub const CommitRevealUnsignedPriority: TransactionPriority = TransactionPriority::max_value();
// }
// impl pallet_a_commit_reveal::Config for Runtime {
// 	type AuthorityId = ImOnlineId;
// 	type ValidatorSet = Historical;
// 	type UnsignedPriority = CommitRevealUnsignedPriority;
// }

// use pallet_a_offchain_signed_transaction::crypto::TestAuthId as SignedTransactionAuthId;
...
// impl pallet_a_offchain_signed_transaction::Config for Runtime {
// 	type Event = Event;
// 	type AuthorityId = SignedTransactionAuthId;
// 	type Call = Call;
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		// user pallet
		// CommitReveal: pallet_a_commit_reveal::{Pallet, Call, Storage, ValidateUnsigned},
		// SignedTransaction: pallet_a_offchain_signed_transaction::{Pallet, Call, Storage, Event<T>},
		// OffchainWorker: pallet_example_offchain_worker::{Pallet, Call, Storage, Event<T>, ValidateUnsigned, Config<T>},
	}
);
