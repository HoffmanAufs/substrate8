...
pub fn new_full(mut config: Configuration) -> Result<TaskManager, ServiceError> {
	...
	// 	let aura_committee = sc_consensus_aura::start_aura::<AuraPair, _, _, _, _, _, _, _, _, _, _, _>(
	// 		StartAuraParams {
	// 			slot_duration,
	// 			client: client.clone(),
	...
	// 	task_manager.spawn_essential_handle().spawn_blocking("aura", aura_committee);
	// }
